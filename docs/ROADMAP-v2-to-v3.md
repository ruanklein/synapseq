# SynapSeq Migration Roadmap: From V2 (C) to V3 (Go)
...
Status: This migration roadmap is fully completed. ✅

The original C-based implementation of SynapSeq (V2) is still available for reference in the repository under the [v2 branch](https://github.com/ruanklein/synapseq/tree/v2).
...
- ~~Separate the core from additional features, creating a mechanism for addons.~~ (not planned for now)
- ~~Following the addon idea, add export formats such as MP3, OGG, and others.~~ (planned for next ROADMAP)
